    ...
    >
      {mobile ? (
        <div className="relative h-full w-full overflow-visible" style={{ touchAction: 'none' }}>
          <div className="absolute top-[35%] right-[-34%] w-[76vw] -translate-y-1/2">
            <canvas
              ref={canvasRef}
        ...
        <div className="relative flex h-[580px] w-full items-start justify-center">
          ...
          <div className="absolute right-0 top-[40%] z-20 flex -translate-y-1/2 flex-col items-center gap-3">
            <button
              type="button"
